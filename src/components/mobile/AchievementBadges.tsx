...
const AchievementBadgesRaw: React.FC<AchievementBadgesProps> = ({
  achievements,
  isDark = false,
}) => {
...
export const AchievementBadges: React.FC<AchievementBadgesProps> = React.memo(AchievementBadgesRaw);
